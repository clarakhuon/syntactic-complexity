---
title: "Task Y - Bivariate Correlations (Partial Correlations)"
author: "Clara Khuon"
...
```{r}
taskY_final_df <- taskY_final 
  
taskY_cor5 <- pcor.test(taskY_final_df$T5_PHQ9_Total, taskY_final_df$news_av_lemma_construction_freq_type, taskY_final_df$nwords) 
taskY_cor6 <- pcor.test(taskY_final_df$T5_PHQ9_Total, taskY_final_df$news_av_lemma_construction_freq_log_stdev, taskY_final_df$nwords) 
