---
title: "Task V - Bivariate Correlations (Partial Correlations)"
author: "Clara Khuon"
...
# Partial Correlations with Total Words as Covariate
Run selection of bivariate correlations (Pearson's) between PHQ-9 total and linguistic features, with total words as a covariate
```{r}
taskV_final_df <- taskV_final

taskV_cor1 <- pcor.test(taskV_final_df$T2_PHQ9_Total, taskV_final_df$nn_pobj_deps_NN_struct, taskV_final_df$nwords)
taskV_cor2 <- pcor.test(taskV_final_df$T2_PHQ9_Total, taskV_final_df$fic_lemma_ttr, taskV_final_df$nwords) 
taskV_cor3 <- pcor.test(taskV_final_df$T2_PHQ9_Total, taskV_final_df$all_construction_ttr, taskV_final_df$nwords) 
taskV_cor4 <- pcor.test(taskV_final_df$T2_PHQ9_Total, taskV_final_df$all_lemma_construction_attested, taskV_final_df$nwords) 
